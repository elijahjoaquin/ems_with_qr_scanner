					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php 
								$sql = "SELECT tblevaluation.id as eid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblevaluation.Question1,tblevaluation.Question2,tblevaluation.PostingDate from tblevaluation join tblemployees on tblevaluation.empid=tblemployees.emp_id where tblemployees.role = 'Staff' and tblemployees.Department = '$session_depart' and empid = '$session_id' order by id desc";
