			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblemployees.Av_leave,tblemployees.Leave_Business,tblemployees.Leave_Vacation,tblemployees.Leave_Emergency,tblemployees.Leave_Paternity,tblemployees.Leave_Maternity,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.admin_status,tblleaves.registra_remarks,tblleaves.AdminRemarkDate,tblleaves.num_days from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id where tblleaves.id=:lid";
