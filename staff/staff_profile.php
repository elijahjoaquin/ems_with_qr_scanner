													...
													<div class="profile-edit-list row">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input name="fname" class="form-control form-control-lg" type="text" required="true" readonly autocomplete="off" value="<?php echo $row['FirstName']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Last Name</label>
																<input name="lastname" class="form-control form-control-lg" type="text" placeholder="" required="true" readonly autocomplete="off" value="<?php echo $row['LastName']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Email Address</label>
																<input name="email" class="form-control form-control-lg" type="text" placeholder="" required="true" readonly autocomplete="off" value="<?php echo $row['EmailId']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Phone Number</label>
																<input name="phonenumber" class="form-control form-control-lg" type="text" placeholder="" required="true" readonly autocomplete="off" value="<?php echo $row['Phonenumber']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Date Of Birth</label>
																<input name="dob" class="form-control form-control-lg date-picker" type="text" placeholder="" required="true" readonly autocomplete="off" value="<?php echo $row['Dob']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Gender</label>
																<input name="gender" class="form-control form-control-lg" type="text" placeholder="" required="true" readonly autocomplete="off" value="<?php echo $row['Gender']; ?>">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input name="department" class="form-control form-control-lg" type="text" required="true" autocomplete="off" readonly value="<?php echo $row['Department']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<?php
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input class="form-control form-control-lg" type="text" required="true" autocomplete="off" readonly value="<?php echo $row['Av_overtime']; ?>">
															</div>
														</div>
