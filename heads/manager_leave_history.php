					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">All Applied Leaves</div>
							</div>
...
-->
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">ALL OF MY LEAVES</h2>
					</div>
				<div class="pb-20">
                                  ...
                                  <td><?php echo htmlentities($result->num_days);?></td>
								   ...
								   <td>
									  <div class="table-actions">
										<a title="VIEW" href="manager_view_leave.php?edit=<?php echo htmlentities($result->id);?>" data-color="#265ed7"><i class="icon-copy dw dw-eye"></i></a>
									  </div>
								   </td>
							</tr>
							<?php $cnt++;} }?>  
