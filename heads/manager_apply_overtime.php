...
date_default_timezone_set('Asia/Manila');
	...
	elseif($num_hrs <= 0 )
	{
        ...
        mysqli_query($conn,"INSERT INTO auditlog (Action, PostingDate, Actor_ID, Department, Role) VALUES('Manager Applied Overtime', '$PostingDate', '$empid', '$session_depart', 'HOD') 
		") or die(mysqli_error()); 
		...
		if($lastInsertId)
		{
			...
			echo "<script type='text/javascript'> document.location = 'manager_overtime_history.php'; </script>";
		}
		else 
		{
