...
date_default_timezone_set('Asia/Manila');
	...
	elseif($leave_type== 'Vacation Leave' && $Leave_Vacation > 0){
        ...
        mysqli_query($conn,"INSERT INTO auditlog (Action, PostingDate, Actor_ID, Department, Role) VALUES('Manager Applied Vacation Leave', '$PostingDate', '$empid', '$session_depart', 'HOD') 
		") or die(mysqli_error()); 
		...
		if($lastInsertId)
		{
			...
			echo "<script type='text/javascript'> document.location = 'manager_leave_history.php'; </script>";
		}
		else 
		{
	...
	//Emergency Leave
		...
		$PostingDate = date('Y-m-d H:i:s');
        mysqli_query($conn,"INSERT INTO auditlog (Action, PostingDate, Actor_ID, Department, Role) VALUES('Manager Applied Emergency Leave', '$PostingDate', '$empid', '$session_depart', 'HOD') 
		") or die(mysqli_error()); 
	...
	//Paternity Leave
		...
		$PostingDate = date('Y-m-d H:i:s');
        mysqli_query($conn,"INSERT INTO auditlog (Action, PostingDate, Actor_ID, Department, Role) VALUES('Manager Applied Paternity Leave', '$PostingDate', '$empid', '$session_depart', 'HOD') 
		") or die(mysqli_error()); 
	...
	//Maternity Leave
        ...
        {
             echo "<script>alert('Applied Days Exceeds Maternity Leave Limit. Leave Application Failed');</script>";
        }
        else
        {
		$sql="INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Description,Status,IsRead,empid,num_days,PostingDate) VALUES(:leave_type,:fromdate,:todate,:description,:status,:isread,:empid,:num_days,:datePosting)";
        ...
        $PostingDate = date('Y-m-d H:i:s');
        mysqli_query($conn,"INSERT INTO auditlog (Action, PostingDate, Actor_ID, Department, Role) VALUES('Manager Applied Business Leave', '$PostingDate', '$empid', '$session_depart', 'HOD') 
		") or die(mysqli_error()); 
						...
						<form method="post" action="">
							<section>
								...
								<div class="row">
									...
									<!-- Available leave days for all Leave types (just hidden :3) -->
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
