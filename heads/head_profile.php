												...
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Gender</label>
																<input name="gender" class="form-control form-control-lg date-picker" type="text" placeholder="" required="true" readonly autocomplete="off" value="<?php echo $row['Gender']; ?>">
