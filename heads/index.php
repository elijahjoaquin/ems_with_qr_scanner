		...
		<div class="pd-ltr-20">
			...
			<div class="row pb-10">
				<div class="col-xl-6 col-lg-6 col-md-6 mb-20">
					...
					<?php
						$status=0;
						$sql = "SELECT id from tblleaves where status=:status and seen_status = 0;";
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						$status=0;
						$managerstat=1;
						$sql = "SELECT id from tblovertime where admin_status=:status and seen_status = 0";
						$query = $dbh -> prepare($sql);
						$query->bindParam(':status',$status,PDO::PARAM_STR);
						$query->execute();
						$results=$query->fetchAll(PDO::FETCH_OBJ);
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<?php echo $row['Leave_Vacation'];?></div>
								<div class="font-14 text-secondary weight-500">Available Vacation Leaves</div>
							</div>
							<div class="widget-icon">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">      
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark">
								<?php echo $row['Leave_Emergency'];?>
								</div>
								<div class="font-14 text-secondary weight-500">Available Emergency Leaves</div>
							</div>
							<div class="widget-icon">
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Available Paternity Leaves</div>
							</div>
							<div class="widget-icon">
							...
							<div class="widget-data">
								...
								<?php 
									...
									if($gender == "Female" || $gender == "female"){
										echo $row['Leave_Maternity'];
									}else{
										echo "N/A";
									}
								?>
								</div>
								<div class="font-14 text-secondary weight-500">Available Maternity Leaves</div>
							</div>
							<div class="widget-icon">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">      
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark">
								<?php echo $row['Av_overtime'];?>
								</div>
								<div class="font-14 text-secondary weight-500">Available Overtime Hours</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06"><span class="icon-copy fa fa-hourglass"></span></div>
							</div>
