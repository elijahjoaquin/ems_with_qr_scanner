...
date_default_timezone_set('Asia/Manila');
	...
	$empid=$get_id;
        ...
        mysqli_query($conn,"INSERT INTO auditlog (Action, PostingDate, Actor_ID, Department, Role) VALUES('Manager Applied Employee Evaluation', '$PostingDate', '$empid', '$session_depart', 'HOD') 
		") or die(mysqli_error()); 
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Evaluate Employee</h4>
							<p class="mb-20"></p>
						</div>
					</div>
