...
<?php
	...
	if(isset($_POST['update']))
	{
		...
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Manager Rejected a Leave', '$date', '$session_id', '$session_depart', 'HOD', '$did')         
		") or die(mysqli_error());
		...
		elseif ($status === '1'/*&& $LeaveType === 'Emergency Leave'*/) {
		    
		      $date = date('Y-m-d H:i:s');
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Manager Approved a Leave', '$date', '$session_id', '$session_depart', 'HOD', '$did')         
		") or die(mysqli_error());
