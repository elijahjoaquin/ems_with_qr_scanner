			...
			<div class="row pb-10">
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$sql = "SELECT emp_id from tblemployees where Department = :depart";
						$query = $dbh -> prepare($sql);
						$query->bindParam(':depart',$session_depart,PDO::PARAM_STR);
						$query->execute();
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Total Staff in the Department</div>
							</div>
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Approved Leaves</div>
							</div>
							<div class="widget-icon">
