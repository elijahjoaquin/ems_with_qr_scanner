...
<?php 
$seenstatusadmin = 1;
$sql = "UPDATE tblleaves SET seen_status_admin='$seenstatusadmin' WHERE id > 0";
	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">PENDING LEAVE FOR EMPLOYEES</h2>
					</div>
				<div class="pb-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">PENDING LEAVE FOR MANAGERS</h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
						...
						<tbody>
							<tr>
								...
								$status=0;
								$reg_status=0;
								$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status, tblleaves.admin_status from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id where tblleaves.Status= '$status' and tblemployees.role = 'HOD' and tblleaves.admin_status = '$reg_status' order by lid desc";
									$query = mysqli_query($conn, $sql) or die(mysqli_error());
									while ($row = mysqli_fetch_array($query)) {
								 ?>  
								...
								<td>
									<div class="table-actions">
										<a title="VIEW" href="leave_details_manager.php?leaveid=<?php echo $row['lid'];?>"><i class="dw dw-eye" data-color="#265ed7"></i></a>	
									</div>
								</td>
							</tr>
							<?php }?>
