...
<?php include 'qrcode_generate/phpqrcode/qrlib.php'?>
<?php
...
if (isset($_GET['delete'])) {
	...
	if ($result) {
		...
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Administrator Deleted a Staff', '$date', '$session_id', '$session_depart', 'Admin', '$did')         
		") or die(mysqli_error());
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentName where role != 'Admin' ORDER BY tblemployees.emp_id") or die(mysqli_error());
								...
								<td align ="center"><?php
									$serial=$row['qr_id'];
									$file = 'qrcode_generate/images/'.$serial.'.png';
							 
									$ecc = 'H';
									$pixel_size = 20;
									$frame_size = 1;
									QRcode::png($serial, $file, $ecc, $pixel_size, $frame_size);
									echo "<div><img src='".$file."' width='60' height='60'></div>";
									echo $serial;
							?></td>
								...
								<td><?php echo $row['Av_overtime']; ?></td>
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											...
											<a onclick='javascript:confirmationDelete($(this));return false;' class="dropdown-item" href="staff.php?delete=<?php echo $row['emp_id'];?>"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
							</tr>
