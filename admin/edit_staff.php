...
date_default_timezone_set('Asia/Manila');
	...
	$Leave_Emergency=$_POST['Leave_Vacation'];
	$Leave_Paternity=$_POST['Leave_Vacation'];
	$Leave_Maternity=$_POST['Leave_Vacation'];
	$overtime_hours=$_POST['overtime_hours']; 
	$user_role=$_POST['user_role']; 
	$phonenumber=$_POST['phonenumber']; 

	$result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Department='$department', Address='$address', Av_leave='$leave_days',Leave_Vacation = '$Leave_Vacation',Leave_Emergency = '$Leave_Emergency',Leave_Paternity = '$Leave_Paternity',Leave_Maternity = '$Leave_Maternity',Av_overtime='$overtime_hours', role='$user_role', Phonenumber='$phonenumber' where emp_id='$get_id'         
		"); 
	
	if ($result) {
	    $date = date('Y-m-d H:i:s');
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Administrator Updated Staff', '$date', '$session_id', '$session_depart', 'Admin', '$did')         
		") or die(mysqli_error());
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="password" type="password" placeholder="**********" class="form-control" readonly="true" autocomplete="off" value="<?php echo substr($row['Password'],0,10); ?>">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
										...
										<div class="form-group">
											...
											<select name="department" class="custom-select form-control" required="true" autocomplete="off">
												<?php
												 ...
												 ?>
												<option value="<?php echo $row_staff['DepartmentName']; ?>"><?php echo $row_staff['DepartmentName']; ?></option>
													<?php
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										...
										<div class="form-group">
											...
											<input name="Leave_Vacation" type="text" class="form-control" required="true" autocomplete="off"value="<?php echo $new_row['Leave_Vacation']; ?>">
											<div class="form-group">
											<label>Emergency Leave Days :</label>
											<input name="Leave_Emergency" type="text" class="form-control" required="true" autocomplete="off"value="<?php echo $new_row['Leave_Emergency']; ?>">
										</div>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Leave Paternity :</label>
											<input name="Leave_Paternity" type="text" class="form-control" required="true" autocomplete="off"value="<?php echo $new_row['Leave_Paternity']; ?>">
											<label>Leave Maternity :</label>
											<input name="Leave_Maternity" type="text" class="form-control" required="true" autocomplete="off"value="<?php echo $new_row['Leave_Maternity']; ?>">
