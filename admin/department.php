											...
											<tr>
												...
												<td>
													<div class="table-actions">
														...
														<a onclick='javascript:confirmationDelete($(this));return false;' href="department.php?delete=<?php echo htmlentities($result->id);?>" data-color="#e95959"><i class="icon-copy dw dw-delete-3"></i></a>
													</div>
												</td>
											</tr>
