...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/Logo_Hajek_2.1.png" alt=""></div>
		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4 user-icon">
						<img src="../vendors/images/banner-img1.png" alt="">
					</div>
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">Use the side-bar navigation links to access the schedule, leaves, overtime, and other contents of the system.</p>
					</div>
				</div>
			</div>
			...
			<div class="row pb-10">
				<div class="col-xl-6 col-lg-6 col-md-6 mb-20">
					...
					<?php
						$status=0;
						$sql = "SELECT id from tblleaves where status=:status and seen_status = 1 and seen_status_admin = 0";
						...
						<div class="d-flex flex-wrap"> 
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">New Leave Application Request/s</div>
							</div>
							<div class="widget-icon">
								<div class="icon font-14"><a href="pending_leave.php" data-color="#ffffff">View</a></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-6 col-lg-6 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						$status=0;
						$managerstat=1;
						$sql = "SELECT id from tblovertime where admin_status=:status and seen_status = 1 and seen_status_admin = 0";
						$query = $dbh -> prepare($sql);
						$query->bindParam(':status',$status,PDO::PARAM_STR);
						$query->execute();
						$results=$query->fetchAll(PDO::FETCH_OBJ);
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">New Overtime Application Request/s</div>
							</div>
							<div class="widget-icon">
								<div class="icon font-14"><a href="pending_overtime.php" data-color="#ffffff">View</a></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row pb-10">
				<div class="col-xl-4 col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$status=1;
						$sql = "SELECT id from tblovertime where admin_status=:status";
						$query = $dbh -> prepare($sql);
						$query->bindParam(':status',$status,PDO::PARAM_STR);
						$query->execute();
						$results=$query->fetchAll(PDO::FETCH_OBJ);
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo htmlentities($leavecount); ?></div>
								<div class="font-14 text-secondary weight-500">Approved Overtime</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06"><span class="icon-copy fa fa-hourglass"></span></div>
							</div>
				...
				<div class="col-xl-4 col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($leavecount); ?></div>
								<div class="font-14 text-secondary weight-500">Pending Overtime</div>
							</div>
							<div class="widget-icon">
								<div class="icon"><i class="icon-copy fa fa-hourglass-end" aria-hidden="true"></i></div>
							</div>
				...
				<div class="col-xl-4 col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$status=2;
						$sql = "SELECT id from tblovertime where status=:status";
						$query = $dbh -> prepare($sql);
						$query->bindParam(':status',$status,PDO::PARAM_STR);
						$query->execute();
						$results=$query->fetchAll(PDO::FETCH_OBJ);
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($leavecount); ?></div>
								<div class="font-14 text-secondary weight-500">Rejected Overtime</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#ff5b5b"><i class="icon-copy fa fa-hourglass-o" aria-hidden="true"></i></div>
							</div>
  ...
  //-->
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">ALL OVERTIME APPLICATIONS</h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
						...
						<tbody>
							<tr>
								...
								<?php 
								$status=1;
								$sql = "SELECT tblovertime.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,tblovertime.PostingDate,tblovertime.Status, tblovertime.admin_status from tblovertime join tblemployees on tblovertime.empid=tblemployees.emp_id where tblovertime.Status= '$status' order by lid desc limit 10";
									$query = mysqli_query($conn, $sql) or die(mysqli_error());
									while ($row = mysqli_fetch_array($query)) {
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="overtime_details.php?overtimeid=<?php echo $row['lid']; ?>"><i class="dw dw-eye"></i> View</a>
											<a class="dropdown-item" href="admin_dashboard.php?overtimeid=<?php echo $row['lid']; ?>"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
							</tr>
