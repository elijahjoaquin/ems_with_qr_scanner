...
<?php
	...
	{ 
		$filter=1;
		$sql="update tblleaves set filter=:filter where id=:did";
		...
		//Minus operation for all leave types
		$VLEAVE = $Leave_Vacation - $num_days;
        $ELEAVE = $Leave_Emergency - $num_days;
        $PLEAVE = $Leave_Paternity - $num_days;
        $MLEAVE = $Leave_Maternity - $num_days;
		...
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Administrator Rejected a Leave Request', '$date', '$session_id', '$session_depart', 'Admin', '$did')         
		") or die(mysqli_error());
		...
		elseif ($status === '1' && $Leave_Vacation) {
		    
		 $date = date('Y-m-d H:i:s');
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Administrator Approved Vacation Leave', '$date', '$session_id', '$session_depart', 'Admin', '$did')         
		") or die(mysqli_error());
		
				$result = mysqli_query($conn,"update tblleaves, tblemployees set tblleaves.registra_remarks='$description',tblleaves.admin_status='$status',tblleaves.AdminRemarkDate='$admremarkdate', tblemployees.Leave_Vacation='$VLEAVE' where tblleaves.empid = tblemployees.emp_id AND tblleaves.id='$did'");
		...
		elseif ($status === '1' && $Leave_Emergency) {
		        $date = date('Y-m-d H:i:s');
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Administrator Approved Emergency Leave', '$date', '$session_id', '$session_depart', 'Admin', '$did')         
		") or die(mysqli_error());
		
				$result = mysqli_query($conn,"update tblleaves, tblemployees set tblleaves.registra_remarks='$description',tblleaves.admin_status='$status',tblleaves.AdminRemarkDate='$admremarkdate', tblemployees.Leave_Emergency='$ELEAVE' where tblleaves.empid = tblemployees.emp_id AND tblleaves.id='$did'");
	    ...
	    elseif ($status === '1' && $Leave_Paternity) {
		        $date = date('Y-m-d H:i:s');
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Administrator Approved Paternity Leave', '$date', '$session_id', '$session_depart', 'Admin', '$did')         
		") or die(mysqli_error());
		
				$result = mysqli_query($conn,"update tblleaves, tblemployees set tblleaves.registra_remarks='$description',tblleaves.admin_status='$status',tblleaves.AdminRemarkDate='$admremarkdate', tblemployees.Leave_Paternity='$PLEAVE' where tblleaves.empid = tblemployees.emp_id AND tblleaves.id='$did'");
		...
		elseif ($status === '1' && $Leave_Maternity) {
		        $date = date('Y-m-d H:i:s');
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Administrator Approved Maternity Leave', '$date', '$session_id', '$session_depart', 'Admin', '$did')         
		") or die(mysqli_error());
		
				$result = mysqli_query($conn,"update tblleaves, tblemployees set tblleaves.registra_remarks='$description',tblleaves.admin_status='$status',tblleaves.AdminRemarkDate='$admremarkdate', tblemployees.Leave_Maternity='$MLEAVE' where tblleaves.empid = tblemployees.emp_id AND tblleaves.id='$did'");
	    ...
	    elseif ($status === '1' && $Leave_Business) {
		        $date = date('Y-m-d H:i:s');
		mysqli_query($conn,"INSERT INTO auditlog(Action, PostingDate, Actor_ID, Department, Role, Recipient_ID) VALUES('Administrator Approved Business Leave', '$date', '$session_id', '$session_depart', 'Admin', '$did')         
		") or die(mysqli_error());
		
				$result = mysqli_query($conn,"update tblleaves, tblemployees set tblleaves.registra_remarks='$description',tblleaves.admin_status='$status',tblleaves.AdminRemarkDate='$admremarkdate', tblemployees.Leave_Business='$Leave_Business' where tblleaves.empid = tblemployees.emp_id AND tblleaves.id='$did'");
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblemployees.Leave_Business,tblemployees.Leave_Vacation,tblemployees.Leave_Emergency,tblemployees.Leave_Paternity,tblemployees.Leave_Maternity,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.admin_status,tblleaves.registra_remarks,tblleaves.AdminRemarkDate,tblleaves.num_days from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id where tblleaves.id=:lid";
						$query = $dbh -> prepare($sql);
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
                                ...
                                <?php 
								    if ($result->LeaveType== 'Business Leave'):?>	
								
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="Leave_Business" value="N/A">
                                							
								<?php 
								    elseif ($result->LeaveType== 'Emergency Leave'):?>	
								
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="Leave_Emergency" value="<?php echo htmlentities($result->Leave_Emergency);?>">
								<?php 
								    elseif($result->LeaveType== 'Vacation Leave'):?>
							
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="Leave_Vacation" value="<?php echo htmlentities($result->Leave_Vacation);?>">
								<?php 
								    elseif($result->LeaveType== 'Paternity Leave'):?>
							
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="Leave_Paternity" value="<?php echo htmlentities($result->Leave_Paternity);?>">
								
								<?php 
								    else:?>
							
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="Leave_Maternity" value="<?php echo htmlentities($result->Leave_Maternity);?>">
								<?php 
								    endif ?>
								...
								<div class="form-group">
									...
									<?php
									 elseif ($stats==2): ?>
									  ...
									  <?php
									 elseif ($stats==3): ?>
									  <input type="text" style="color: orange; font-size: 16px;" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "Waiting"; ?>">
									  <?php
									else: ?>
									  <input type="text" style="color: blue;" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "Pending"; ?>">
									<?php endif ?>
